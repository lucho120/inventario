...
<nav class="navbar navbar-default ">
  <div class="container-fluid">
    ...
    <li class="<?php if (isset($active_mantenimiento)){echo $active_mantenimiento;}?>"><a href="mantenimiento.php"><i class='glyphicon glyphicon-wrench'></i> Mantenimientos</a></li>
